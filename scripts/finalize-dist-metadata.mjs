...
const pages = [
  {
    ...
    structuredData: {
      ...
      areaServed: 'Norway',
      description:
        'Korani Solutions AS helps businesses save time with practical AI, automation, system integration, internal tools, and custom software for manual workflows.',
      knowsAbout: [
        'Workflow automation',
        'Practical AI',
        'System integration',
